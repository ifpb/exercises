...
describe('Number Tools', function () {
  ...
  xit('looking for the first 6 prime numbers', function () {
    expect(primes(6))->toEqual([2, 3, 5, 7, 11, 13]);
  });

  xit('looking for prime numbers >= 2 and <= 10', function () {
    expect(primes(2, 10))->toEqual([2, 3, 5, 7]);
  });

  xit('looking for prime numbers >= 2 and <= 20', function () {
    expect(primes(2, 20))->toEqual([2, 3, 5, 7, 11, 13, 17, 19]);
  });

  xit('looking for prime numbers >= 10 and <= 2', function () {
