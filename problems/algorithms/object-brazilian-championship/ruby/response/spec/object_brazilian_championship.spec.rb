require_relative "../src/object_brazilian_championship"
...
describe BrazilianChampionship do
  describe ".firstTeamByName" do
    context "Getting the name of the first team" do
      it "return Palmeiras" do
        expect(BrazilianChampionship.firstTeamByName(standings)).to eql("Palmeiras")
      end
    end
  end

    describe ".showStandings" do
      context "Get full Standings" do
        it "return full standings" do
          expect(BrazilianChampionship.showStandings(standings)).to be(
