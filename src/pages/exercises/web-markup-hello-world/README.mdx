...
Uma sugestão seria usar a pasta [code.zip](https://download-directory.github.io/?url=https://github.com/ifpb/exercises/tree/main/src/pages/problems/web-markup-hello-world/_codes/html/code/), para depois abrir esta pasta `code` no seu editor de preferência.
