...
<Image src={layoutVisible} alt="Layout da Página" />
...
<Image src={products} alt="Lista de produtos" />
...
<Image src={productSize} alt="Tamanho disponível dos produto" />
...
<Image src={productOff} alt="Produto na promoção" />
...
<Image src={productsFilter} alt="Filtro de produtos" />
