...
*Figura 3 - Filtro por nome*

<Image src={filterByName} alt="Filtro por nome" />
...
*Figura 4 - Filtro por tipo*

<Image src={filterByType} alt="Filtro por tipo" />


**COMPONENTE 4 -** Crie o ordenador da Pokedex para ajudar na listagem da Pokedex conforme a *Figura 5*.

*Figura 5 - Ordenador da Pokedex*

<Image src={sort} alt="Ordenador da Pokedex" />

**COMPONENTE 5 -** Faça que o formulário realize o filtro e ordenação de modo integrado, tal como a *Figura 6*.

*Figura 6 - Ordenador e Filtros combinados*

<Image src={sortFilter} alt="Ordenador e Filtros combinados" />
