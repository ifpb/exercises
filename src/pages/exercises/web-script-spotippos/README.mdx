...
Para ajudar a inicialização do desafio foi definido uma proposta de layout estático disponível no arquivo [site.zip](https://download-directory.github.io/?url=https://github.com/ifpb/exercises/tree/main/src/pages/problems/web-script-spotippos/_codes/js/code/) e ilustrado na Figura 1.
