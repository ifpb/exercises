...
<Image src={layout} alt="Barra de menu" />
...
*Figura 3 - Texto dos banners*

<Image src={banner} alt="Texto dos banners" />
...
<Image src={services} alt="Serviços" />
...
<Image src={social} alt="Redes sociais" />
