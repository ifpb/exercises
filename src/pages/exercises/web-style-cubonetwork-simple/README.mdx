...
A princípio já foi disponibilizado uma estrutura básica do site que se encontra no arquivo [site.zip](https://download-directory.github.io/?url=https://github.com/ifpb/exercises/tree/main/src/pages/problems/web-markup-cubonetwork-simple/_codes/css/code/), e é exigido a criação de no mínimo 3 componentes.
