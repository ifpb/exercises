---
title: Desafio Front-end do Cubo Network
preview: true
challenge: true
subjects:
  - web
...
import menu from './_assets/menu.png';
import banner from './_assets/banner.png';
import services from './_assets/services.png';
import table from './_assets/table.png';
import social from './_assets/social.png';

## Descrição

A empresa [Cubo Network](https://github.com/cubonetwork/frontend-challenge) está buscando profissionais para o preenchimento de vagas de Front-end. Para auxiliar o processo de contratação foi desenvolvido um desafio que exige a criação de alguns componentes visuais, que serão descritos a seguir, do layout do site da _Figura 1_.

_Figura 1 - Layout do site._

<Image src={layout} alt="Layout da Página" class="border p-4" />

A princípio já foi disponibilizado uma estrutura básica do site que se encontra no arquivo [code.zip](https://download-directory.github.io/?url=https://github.com/ifpb/exercises/tree/main/src/pages/exercises/web-style-cubonetwork-simple/_codes/css/code/), e é exigido a criação de no mínimo 3 componentes.

## Componentes

**COMPONENTE 1 -** Crie a barra de menu conforme ilustra a _Figura 2_:

_Figura 2 - Barra de menu._

<Image src={layout} alt="Barra de menu" class="border p-4" />
...
- A primeira opção do menu na _Figura 2_ deve estar em destaque com a aparência diferente dos demais usando a cor do plano de fundo de `#e76924`, a cor de texto branca e com arredondamento de borda (`border-radius: 4px`).

**COMPONENTE 2 -** Estilize o texto do banner conforme ilustra a _Figura 3_:

_Figura 3 - Texto dos banners._

<Image src={banner} alt="Texto dos banners" class="border p-4" />
...
**COMPONENTE 3 -** Estilize a lista de serviços conforme ilustra a _Figura 4_:

_Figura 4 - Serviços._

<Image src={services} alt="Serviços" class="border p-4" />
...
- Em `<!-- TODO Serviços -->`, no arquivo `index.html`, cada serviço deve apresentar a estrutura HTML a seguir:
  ...
  <div class="service">
    <div class="logo">
      <img src="img/service1.png" alt="" class="border p-4" />
    </div>
    <div class="description">
      <h1>Rhoncus purus in</h1>
      <p>
        Donec sit amet erat ut quam dignissim bibendum porta enim, ut acor
        tempor felis diam non massa. Pellentesque habitant morbi tristique
...
**COMPONENTE 4 -** Estilize a tabela conforme ilustra a _Figura 5_:

_Figura 5 - Tabela._

<Image src={table} alt="Tabela" class="border p-4" />
...
**COMPONENTE 5 -** Estilize os ícones das redes sociais conforme ilustra a _Figura 6_:

_Figura 6 - Redes sociais._

<Image src={social} alt="Redes sociais" class="border p-4" />
