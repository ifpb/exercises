...
A princípio foi fornecido, textualmente, algumas informações que estão disponíveis no arquivo compactado [site.zip](https://download-directory.github.io/?url=https://github.com/ifpb/exercises/tree/main/src/pages/problems/web-markup-curriculum-text/_codes/html/code/). Também foi fornecido foto e algumas descrições, que juntos deverão ser apresentados em um navegador Web, conforme ilustra a *Figura 1*.
