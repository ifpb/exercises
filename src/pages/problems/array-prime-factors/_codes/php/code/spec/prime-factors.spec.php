...
describe('Prime Factors', function () {
  ...
  xit('factoring 2', function () {
    expect(primeFactors(2))->toEqual([2]);
  });

  xit('factoring 3', function () {
    expect(primeFactors(3))->toEqual([3]);
  });

  xit('factoring 4', function () {
    expect(primeFactors(4))->toEqual([2, 2]);
  });

  xit('factoring 6', function () {
    expect(primeFactors(6))->toEqual([2, 3]);
  });

  xit('factoring 8', function () {
    expect(primeFactors(8))->toEqual([2, 2, 2]);
  });

  xit('factoring 9', function () {
    expect(primeFactors(9))->toEqual([3, 3]);
  });

  xit('factoring 27', function () {
    expect(primeFactors(27))->toEqual([3, 3, 3]);
  });

  xit('factoring 625', function () {
    expect(primeFactors(625))->toEqual([5, 5, 5, 5]);
  });

  xit('factoring 901255', function () {
    expect(primeFactors(901255))->toEqual([5, 17, 23, 461]);
  });

  xit('factoring 93819012551', function () {
