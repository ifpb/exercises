...
describe('Calendar', function () {
 ...
 29  30  31";
  ...
  xit('making month starting on Monday and ending on the 31st', function () {
    $expected = "DOM SEG TER QUA QUI SEX SAB
     01  02  03  04  05  06
 ...
 28  29  30  31";
  ...
  xit('making month starting on Tuesday and ending on the 30st', function () {
    $expected = "DOM SEG TER QUA QUI SEX SAB
         01  02  03  04  05
 ...
 27  28  29  30";
  ...
  xit('making month starting on Wednesday and ending on the 29st', function () {
    $expected = "DOM SEG TER QUA QUI SEX SAB
             01  02  03  04
 ...
 26  27  28  29";
  ...
  xit('making month starting on Saturday and ending on the 31st', function () {
    $expected = "DOM SEG TER QUA QUI SEX SAB
                         01
